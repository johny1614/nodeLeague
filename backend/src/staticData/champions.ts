...
export const championsData: ChampionsData = {
	'type': 'champion',
...
export function getChampionByName(name: string): ChampionData {
	return championsData.data[name];
}

export function getChampionByKey(desiredKey: string): ChampionData {
	const championNames = Object.keys(championsData.data);
	const desiredChampionName =  championNames.find(championName => championsData.data[championName].key === desiredKey);
	return championsData.data[desiredChampionName];
}
